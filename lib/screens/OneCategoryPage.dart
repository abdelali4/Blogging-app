...
class OneCategoryPage extends StatefulWidget {
  ...
  _OneCategoryPageState createState() => _OneCategoryPageState(id: id,Category:Category);
}
                                            ...
                                            builder: (context,ahmed) {
                                              return Row(
                                                ...
                                                children: [
                                                  GestureDetector(
                                                    child: CircleAvatar(
                                                      backgroundImage:ahmed.hasData?(ahmed.data["UserImageUrl"]!=null?
                                                      NetworkImage(ahmed.data["UserImageUrl"]):AssetImage("assets/images/userwithoutprofileimage.png")):
                                                    ...
                                                    onTap: (){
                                                      Navigator.push(context,
                                                          MaterialPageRoute(builder: (context)=>ProfilePageSeenBySomeOne(id:doc.data["Owner"])));
                                                    },
                                                  ),
                                                  SizedBox(width: 15,),
                                                  Expanded(
                                                    child: Container(
                                                      ...
                                                      child: GestureDetector(
                                                        child: Text(
                                                          ahmed.hasData?ahmed.data["Username"]:"",
                                                          style: TextStyle(
                                                              fontSize:17,
                                                              color: Colors.black,
                                                              fontFamily: "Montserrat",
